...
생성: 2026-09-01T19:49:41.479Z · 지연 반복 20회
...
|---|---|---|---|---|---:|---:|---:|---:|
| S1 | 기본형 | 고유 className · 정적 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.14 | 0.04 |
| S2 | 중복 | 동일 className 2개 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.13 | 0.04 |
| S3 | 동적 className | 템플릿 리터럴 + 보간 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.27 | 0.06 |
| S4 | 동적 className | cn() 호출 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.16 | 0.05 |
| S5 | 포맷 | 여러 줄 속성 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.10 | 0.03 |
| S6 | 브레이크포인트 | 반응형 h-32 md:h-48 lg:h-64 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.11 | 0.03 |
| S7 | 반복 렌더 | .map() 안의 항목 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.14 | 0.04 |
| S8 | 위치 이동 | flex 자식 이동 (12px) | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.11 | 0.03 |
| S9 | 포맷 | 단일 따옴표 className | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.15 | 0.04 |
| S10 | 혼합 | prop className 형제 옆의 정적 요소 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.05 | 0.04 |
