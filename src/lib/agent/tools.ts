/**
 * Tool definitions for the WIGSS agent — Anthropic (Claude) tool-use format.
 * Consumed directly by the Claude provider (providers/claude.ts); no translation.
...
export type ToolName = (typeof agentTools)[number]['name'];
