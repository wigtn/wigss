...
생성: 2026-09-01T19:29:01.103Z · 지연 반복 20회

## 요약

| 지표 | A (현행) | B (개선안) | 변화 |
|---|---:|---:|---|
| 편집 정확도 | 10/10 (100%) | 10/10 (100%) | +0pp |
| 대상 해석 성공 | 10/10 (100%) | 10/10 (100%) | +0pp |
| **오편집** (썼는데 틀림) | 0건 | 0건 | 0건 |
| 오염 발생 시나리오 | 0건 | 0건 | 0건 |
| 오염 총 건수 | 0 | 0 | 0 |
| 사유 보고된 포기 | 0건 | 0건 | +0건 |
| 평균 지연 | 0.14 ms | 0.04 ms | 3.7× 빠름 |
...
|---|---|---|---|---|---:|---:|---:|---:|
| S1 | 기본형 | 고유 className · 정적 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.13 | 0.04 |
| S2 | 중복 | 동일 className 2개 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.15 | 0.05 |
| S3 | 동적 className | 템플릿 리터럴 + 보간 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.20 | 0.04 |
| S4 | 동적 className | cn() 호출 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.17 | 0.04 |
| S5 | 포맷 | 여러 줄 속성 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.11 | 0.03 |
| S6 | 브레이크포인트 | 반응형 h-32 md:h-48 lg:h-64 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.11 | 0.03 |
| S7 | 반복 렌더 | .map() 안의 항목 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.15 | 0.04 |
| S8 | 위치 이동 | flex 자식 이동 (12px) | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.15 | 0.03 |
| S9 | 포맷 | 단일 따옴표 className | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.15 | 0.03 |
| S10 | 혼합 | prop className 형제 옆의 정적 요소 | ✅ 정확 | ✅ 정확 | 0 | 0 | 0.05 | 0.03 |
...
- A: 정확 → `flex flex-col h-64 w-64 rounded-lg bg-gray-800 p-5`
  - tailwind · h-48 → h-64
...
- A: 정확 → `flex flex-col h-64 w-64 rounded-lg p-4`
  - tailwind · h-48 → h-64
...
- A: 정확 → `flex flex-col h-64 w-64 rounded-lg p-8`
  - tailwind · h-48 → h-64
...
- A: 정확 → `flex flex-col h-32 md:h-48 lg:h-80 w-full rounded-lg bg-gray-800 p-4`
  - tailwind · lg:h-64 → lg:h-80
...
- A: 정확 → `block rounded px-3 py-2 text-gray-300 mt-3`
  - tailwind · + mt-3
